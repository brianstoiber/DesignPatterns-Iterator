...
public class IteratorPatternTest {
	...
	public void testPrinter() {
		...
		// I had this on a class trip my senior year of high school and have wish I
		// could find it in the US
		...
		/**
		 * I tried to compare the output to the contents on sampleMenu.txt but the test
		 * keeps failing and I can't figure out the cause of it
		 */
		// asserting the output with expected output stored in file
		// using trim function to remove extra spaces if any and get only the string
		// values
